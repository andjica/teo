            ...
            <CardContent>
              ...
              {/* <List noHairlines>
                <ListInput
                  type="select"
                  label="Size"
                  value={selectedVariants[p.id]?.size || p.variants.size[0]}
                  onChange={(e) =>
                ...
                <ListInput
                  type="select"
                  label="Color"
                  value={selectedVariants[p.id]?.color || p.variants.color[0]}
                  onChange={(e) =>
                    handleVariantChange(p.id, 'color', e.target.value)
                  }
                >
              ...
              <div className="mt-2">
                ...
                {/* <span className="text-color-gray">
                  {' '}
                  + PDV €{(p.price * p.taxRate).toFixed(2)}
                </span> */}
              </div>
              ...
              <div className="flex justify-between mt-2">
                ...
                <Button outline small custom onClick={() => setProductDetailOpen(p)}>
                  See more
                </Button>
              </div>
            </CardContent>
